...
window.onload = () => {
    ...
    <div class="header-escritorio">
      <a title="Conectar LAB" href="#top">
         <header>
        <img src="./ImgeIEBLA/UBB.png" alt="Logo de la Union Bautista Boliviana" style="width: 150px; height: 80px;>
        <h1>Union Bautista Boliviana</h1>
        <button class="login-button">Inicio de Sesión</button>
        </header>
      ...
      <nav class="header-nav" >
        <ul>
          ...
          <li><a href="#images">Quienes somos </a></li>
    ...
    <div>
      <img title="Ciencias" class="footer-logo" src="../ImgeIEBLA/IMG_20240811_210654 - La Lumbera Iglesia Evangelica Bautista.jpg" alt="Logo ciencia">
    ...
    <a title="Conectar LAB" href="#top">
      <img class="header-logo" src="../ImgeIEBLA/ubb_carril.png"  >
    </a>
  `;
  };
